...
* The original package name 'com.moicro.phase2.configserver.config-server' is invalid and this project uses 'com.moicro.phase2.configserver.configserver' instead.
